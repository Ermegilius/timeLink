const GameplayTimes = [
    "the very early stage of the forming Earth. This is a fun place, let's find out more about it!",
    ...
    "1969: You are witnessing the first time people left the Earth to land on the moon—explorers like you!",
