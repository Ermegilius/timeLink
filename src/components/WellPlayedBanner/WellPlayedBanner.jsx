import wellPlayedImage from '../../assets/wellplayedBanner.png';
  ...
  return (
    <div className="wellplayed-banner h-[466px] max-h-[466px] min-h-[466px]">
        ...
        <div className="typewriter-text absolute top-[117px] left-[680px] transform -translate-x-1/2 whitespace-normal text-left w-[27%] leading-[1.5] font-typewriter text-[30px] z-30">
            <p>Well played!</p>
