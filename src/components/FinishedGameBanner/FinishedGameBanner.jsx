...
import beamBobImage from '../../assets/beambob.png';
  ...
  return (
    <div className="finishedgame-banner h-[541px] max-h-[541px] min-h-[541px] border-2 border-[#8168fe] rounded-md shadow-[0_4px_4px_rgba(0,0,0,0.25),0_3px_6px_rgba(0,0,0,0.22)]">
        <img className="finishedgame-img block w-full h-[541px] max-h-[541px] min-h-[541px] z-10 relative" src={finishedGameImage} alt="alien beamed up to ufo to leave back to home planet" />
