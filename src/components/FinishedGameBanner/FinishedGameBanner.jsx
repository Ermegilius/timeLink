...
import beamBobImage from '../../assets/beambob.png';
  ...
  return (
    <div className="finishedgame-banner border-2 border-[#8168fe] rounded-md shadow-[0_4px_4px_rgba(0,0,0,0.25),0_3px_6px_rgba(0,0,0,0.22)]">
        <img className="finishedgame-img block max-h-[541px] w-full z-10 relative" src={finishedGameImage} alt="alien beamed up to ufo to leave back to home planet" />
        ...
        <div className="typewriter-text absolute top-[250px] left-[968px] transform -translate-x-1/2 whitespace-normal text-left w-[445px] leading-[1] font-typewriter text-[30px] z-30">
            {displayText.split("\n").map((line, index) => (
