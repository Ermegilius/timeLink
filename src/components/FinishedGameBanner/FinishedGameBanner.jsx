...
import beamBobImage from '../../assets/beambob.png';
  ...
  return (
    <div className="finishedgame-banner h-[542px] max-h-[542px] min-h-[542px] w-[1314px] border-2 border-[#8168fe] rounded-md shadow-[0_4px_4px_rgba(0,0,0,0.25),0_3px_6px_rgba(0,0,0,0.22)]">
        <img className="finishedgame-img block h-[538px] max-h-[538px] min-h-[538px] w-[1314px] z-10 relative" src={finishedGameImage} alt="alien beamed up to ufo to leave back to home planet" />
